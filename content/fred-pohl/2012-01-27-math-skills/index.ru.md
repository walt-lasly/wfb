...
** Несколько цифр о том, насколько разные люди разбираются в арифметике:**

- % населения, считающих, что они достаточно хорошо знают домашнюю математику, чтобы справляться с задачами: 80%
- % населения, правильно ответившего по крайней мере на половину тестовых вопросов в тесте по арифметике для шестого класса: 42%


Чем меньше люди знают математику, тем увереннее они в своих решениях.

- Баллы по тесту простой арифметики людей, которые уже были лишены права выкупа:
- Готовность обратиться за помощью и/ или провести исследование: Наиболее информированный: наиболее вероятно, наименее информированный: наименее вероятно
